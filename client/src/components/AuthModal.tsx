      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-full py-2 rounded-lg text-sm font-medium text-white focus-visible:outline focus-visible:ring-2 focus-visible:ring-[var(--hi-accent)]"
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.7)" }} onClick={onClose}>
      <div
        ...
        className="glass-card rounded-xl p-6 max-w-sm w-full max-h-[min(90vh,40rem)] overflow-y-auto outline-none focus-visible:ring-2 focus-visible:ring-[var(--hi-accent)]/50"
        style={{ background: "rgba(5,13,26,0.98)" }}
        tabIndex={-1}
        onClick={(e) => e.stopPropagation()}
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          {mode === "signup" && (
            <div className="space-y-1">
              <label htmlFor="auth-name" className="text-xs font-medium block" style={{ color: "var(--hi-muted,#5c5c58)" }}>
                Display name
              </label>
              <input
                id="auth-name"
          ...
          <div className="space-y-1">
            <label htmlFor="auth-email" className="text-xs font-medium block" style={{ color: "var(--hi-muted,#5c5c58)" }}>
              Email
            </label>
            <input
              id="auth-email"
          ...
          <div className="space-y-1">
            <label htmlFor="auth-password" className="text-xs font-medium block" style={{ color: "var(--hi-muted,#5c5c58)" }}>
          ...
          <button
            ...
            style={{ background: "var(--hi-accent)", opacity: loading ? 0.6 : 1 }}
          >
