...
export const playoffSeries: PlayoffSeries[] = [
  {
    ...
    games: [
      { gameNumber: 1, date: "2026-04-19", homeTeam: "DET", awayTeam: "ORL", homeScore: null, awayScore: null, status: "scheduled", time: "6:30 PM ET", tv: "NBC, Peacock" },
    ],
  },
  {
    seriesId: "E2-BOS-PHI",
    ...
    summary: "Series tied 0-0",
    games: [
      { gameNumber: 1, date: "2026-04-19", homeTeam: "BOS", awayTeam: "PHI", homeScore: null, awayScore: null, status: "scheduled", time: "1:00 PM ET", tv: "ABC" },
    ],
  },
  {
    seriesId: "E3-NY-ATL",
    ...
    games: [
      { gameNumber: 1, date: "2026-04-18", homeTeam: "NY", awayTeam: "ATL", homeScore: 113, awayScore: 102, status: "final", topPerformer: "Jalen Brunson", topLine: "26 PTS · 7 AST" },
    ],
  },
  {
    seriesId: "E4-CLE-TOR",
    ...
    games: [
      { gameNumber: 1, date: "2026-04-18", homeTeam: "CLE", awayTeam: "TOR", homeScore: 126, awayScore: 113, status: "final", topPerformer: "Evan Mobley", topLine: "31 PTS · 12 REB · 4 BLK" },
    ],
  },
  {
    seriesId: "W1-OKC-PHX",
    ...
    summary: "Series tied 0-0",
    games: [
      { gameNumber: 1, date: "2026-04-19", homeTeam: "OKC", awayTeam: "PHX", homeScore: null, awayScore: null, status: "scheduled", time: "3:30 PM ET", tv: "ABC" },
    ],
  },
  {
    seriesId: "W2-SAS-POR",
    ...
    summary: "Series tied 0-0",
    games: [
      { gameNumber: 1, date: "2026-04-19", homeTeam: "SAS", awayTeam: "POR", homeScore: null, awayScore: null, status: "scheduled", time: "9:00 PM ET", tv: "NBC, Peacock" },
    ],
  },
  {
    seriesId: "W3-DEN-MIN",
    ...
    lowerWins: 0,
    status: "active",
    summary: "DEN leads 1-0",
    games: [
      { gameNumber: 1, date: "2026-04-18", homeTeam: "DEN", awayTeam: "MIN", homeScore: 116, awayScore: 105, status: "final", topPerformer: "Nikola Jokić", topLine: "24 PTS · 11 AST" },
    ],
  },
  {
    seriesId: "W4-LAL-HOU",
    ...
    games: [
      { gameNumber: 1, date: "2026-04-18", homeTeam: "LAL", awayTeam: "HOU", homeScore: 107, awayScore: 98, status: "final", topPerformer: "Anthony Davis", topLine: "25 PTS · 11 REB · 3 BLK" },
    ],
  },
];
