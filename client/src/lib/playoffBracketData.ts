...
export const confFinalsSeries: PlayoffSeries[] = [
  {seriesId:"east-r3",conference:"east",round:3,higherSeed:1,lowerSeed:3,higherTeam:"NYK",lowerTeam:"TBD",higherWins:0,lowerWins:0,status:"scheduled",games:[],narrative:"The Knicks await the winner of DET vs CLE Game 7 on Sunday. If Detroit wins at home, the 1-seed earns home-court advantage in the East Finals. If Cleveland pulls the road upset, the 3-seed Knicks get home court against the 4-seed Cavaliers. Either way, Brunson and the fully rested Knicks are the favorites.",keyMatchup:"Brunson vs Cunningham or Mitchell — either matchup defines the East"},
  {seriesId:"west-r3",conference:"west",round:3,higherSeed:1,lowerSeed:2,higherTeam:"OKC",lowerTeam:"SAS",higherWins:0,lowerWins:0,status:"scheduled",games:[],narrative:"THE DREAM MATCHUP IS SET. Shai Gilgeous-Alexander vs Victor Wembanyama. The reigning MVP vs the reigning DPOY. The defending champions (8-0) vs the franchise that hasn't reached a Conference Finals since 2017. Oklahoma City has home-court advantage but San Antonio just demolished Minnesota by 30 in a road closeout. The Spurs' depth — Castle, Fox, Wemby, Vassell, Harper — may be the only roster in basketball that can match OKC's. Series likely begins Wednesday, May 20.",keyMatchup:"SGA vs Wembanyama — the generational showdown the basketball world has been waiting for"},
];
...
export const mvpCandidates: MvpCandidate[] = [
  {rank:1,player:"Shai Gilgeous-Alexander",team:"OKC",odds:"-180",playoffAvg:"30.1 PPG, 6.2 RPG, 6.5 APG",record:"8-0 (two sweeps)",signatureMoment:"35-point, 8-assist sweep-clincher against the Lakers — 8-0 and awaiting the West Finals",trend:"steady"},
  {rank:2,player:"Victor Wembanyama",team:"SAS",odds:"+400",playoffAvg:"24.3 PPG, 10.8 RPG, 3.2 BPG",record:"8-3 (advancing to WCF)",signatureMoment:"Coasted through the clincher while Castle went supernova — the 27/17/3BLK Game 5 was his masterpiece",trend:"up"},
  {rank:3,player:"Jalen Brunson",team:"NYK",odds:"+450",playoffAvg:"27.8 PPG, 6.3 APG, 3.8 RPG",record:"8-2 (swept PHI in R2)",signatureMoment:"33-point Game 3 clincher on the road — orchestrated the most dominant sweep of the playoffs",trend:"steady"},
  {rank:4,player:"Stephon Castle",team:"SAS",odds:"+1200",playoffAvg:"18.5 PPG, 6.2 RPG, 3.8 APG",record:"8-3 (advancing to WCF)",signatureMoment:"32/11/6 on 11-16 FG in the series-clinching Game 6 blowout — the best close-out game by a sophomore in playoff history",trend:"up"},
  {rank:5,player:"Cade Cunningham",team:"DET",odds:"+2500",playoffAvg:"27.0 PPG, 4.8 RPG, 8.5 APG",record:"7-6 (Game 7 Sunday)",signatureMoment:"39/7/9 in Game 5, then orchestrated a 21-point road blowout in Game 6 — the series' best player needs one more win",trend:"up"},
];

// --- Elimination Watch ---

export const eliminationWatch: EliminationWatch[] = [
  {team:"DET",opponent:"CLE",situation:"GAME 7 AT HOME — Series tied 3-3. Winner advances to East Finals vs NYK.",gameInfo:"CLE @ DET, May 17 (Sunday), TBD, ABC — Cunningham has been the series' best player and gets Little Caesars Arena rocking",urgency:"tied"},
  {team:"CLE",opponent:"DET",situation:"GAME 7 ON THE ROAD — Series tied 3-3. Must win at Little Caesars Arena to reach East Finals.",gameInfo:"CLE @ DET, May 17 (Sunday), TBD, ABC — Mitchell and Harden must rebound from catastrophic Game 6",urgency:"tied"},
  {team:"OKC",opponent:"SAS",situation:"West Finals SET — 8-0, home-court advantage. Series begins ~May 20.",gameInfo:"OKC vs SAS, Western Conference Finals, schedule TBD",urgency:"advancing"},
  {team:"SAS",opponent:"OKC",situation:"West Finals SET — Clinched with 139-109 road blowout. Castle/Fox/Wemby firing on all cylinders.",gameInfo:"OKC vs SAS, Western Conference Finals, schedule TBD",urgency:"advancing"},
  {team:"NYK",opponent:"TBD",situation:"Advancing — Awaiting East Finals opponent (DET or CLE, decided Sunday Game 7)",gameInfo:"East Finals begins after DET-CLE Game 7",urgency:"advancing"},
...
export const bracketMeta = {
  ...
  currentRound: "Conference Semifinals (Game 7 pending) / West Finals set",
  nextMilestone: "SUNDAY — Game 7: CLE @ DET for the East Finals berth. West Finals (OKC vs SAS) schedule TBD, likely begins ~May 20.",
  teamsRemaining: 5,
  teamsEliminated: 15,
  gamesPlayed: 46,
  playInComplete: true,
