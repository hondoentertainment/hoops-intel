...
export const eliminationWatch: EliminationWatch[] = [
  {team:"DET",opponent:"CLE",situation:"Facing elimination — trailing 2-3, must win on the road at Cleveland",gameInfo:"DET @ CLE, May 15, TBD, ESPN — Cunningham's 39 wasn't enough in G5; 1-seed must win away to survive",urgency:"elimination"},
  {team:"MIN",opponent:"SAS",situation:"Facing elimination — trailing 2-3, must win at home to force Game 7",gameInfo:"SAS @ MIN, May 15, TBD — Edwards needs a defining performance to keep the Wolves alive",urgency:"elimination"},
  {team:"CLE",opponent:"DET",situation:"Leading 3-2 — can clinch East Finals at home on Friday",gameInfo:"DET @ CLE, May 15, TBD, ESPN — Harden and Mitchell can close it out at Rocket Mortgage FieldHouse",urgency:"leading"},
  {team:"SAS",opponent:"MIN",situation:"Leading 3-2 — can clinch West Finals at Minnesota on Friday",gameInfo:"SAS @ MIN, May 15, TBD — Wembanyama one win from his first Conference Finals",urgency:"leading"},
...
export const bracketMeta = {
  ...
  nextMilestone: "Elimination Friday — DET @ CLE (East, Game 6) and SAS @ MIN (West, Game 6). Both Conference Finals could be set by Friday night.",
  teamsRemaining: 6,
  teamsEliminated: 14,
  gamesPlayed: 44,
  playInComplete: true,
