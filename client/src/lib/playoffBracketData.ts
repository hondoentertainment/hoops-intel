...
export const confFinalsSeries: PlayoffSeries[] = [
  {seriesId:"east-r3",conference:"east",round:3,higherSeed:3,lowerSeed:4,higherTeam:"NYK",lowerTeam:"CLE",higherWins:2,lowerWins:0,status:"active",games:[{gameNumber:1,date:"May 19",time:"8:00 PM ET",tv:"ESPN",homeTeam:"NYK",awayTeam:"CLE",homeScore:115,awayScore:104,status:"final",topPerformer:"Jalen Brunson",topPerformerLine:"38 PTS, 5 REB, 6 AST, 15-29 FG (OT)"},{gameNumber:2,date:"May 21",time:"8:00 PM ET",tv:"ESPN",homeTeam:"NYK",awayTeam:"CLE",homeScore:109,awayScore:93,status:"final",topPerformer:"Josh Hart",topPerformerLine:"26 PTS, 7 AST, 4 REB, 5-11 3PT, +18"},{gameNumber:3,date:"May 23",time:"8:00 PM ET",tv:"ABC",homeTeam:"CLE",awayTeam:"NYK",homeScore:null,awayScore:null,status:"scheduled"},{gameNumber:4,date:"May 25",time:"8:00 PM ET",tv:"ESPN",homeTeam:"CLE",awayTeam:"NYK",homeScore:null,awayScore:null,status:"scheduled"}],narrative:"The Knicks took a commanding 2-0 ECF lead with a 109-93 Game 2 blowout at MSG. Hart erupted for a career-playoff-high 26, Brunson dished 14 assists with 0 turnovers, and OG Anunoby's plus-22 anchored a defense that held Cleveland to 5-of-24 from three. The series shifts to Cleveland for Games 3-4 on Saturday and Monday. No team has come back from 0-2 in a Conference Finals after losing both road games by a combined 27 points in the three-pointer era.",keyMatchup:"Brunson vs Mitchell — Brunson has 57 PTS and 20 AST across two games to Mitchell's 55 PTS and 4 AST. Brunson is controlling the series with two different skill sets.",seriesOdds:"NYK -400"},
  {seriesId:"west-r3",conference:"west",round:3,higherSeed:1,lowerSeed:2,higherTeam:"OKC",lowerTeam:"SAS",higherWins:1,lowerWins:1,status:"active",games:[{gameNumber:1,date:"May 18",time:"8:30 PM ET",tv:"NBC, Peacock",homeTeam:"OKC",awayTeam:"SAS",homeScore:115,awayScore:122,status:"final",topPerformer:"Victor Wembanyama",topPerformerLine:"41 PTS, 24 REB, 3 AST, +16 (2OT)"},{gameNumber:2,date:"May 20",time:"8:30 PM ET",tv:"NBC, Peacock",homeTeam:"OKC",awayTeam:"SAS",homeScore:122,awayScore:113,status:"final",topPerformer:"Shai Gilgeous-Alexander",topPerformerLine:"30 PTS, 9 AST, 4 REB, +14"},{gameNumber:3,date:"May 22",time:"8:30 PM ET",tv:"NBC, Peacock",homeTeam:"SAS",awayTeam:"OKC",homeScore:null,awayScore:null,status:"scheduled"},{gameNumber:4,date:"May 24",time:"8:00 PM ET",tv:"NBC, Peacock",homeTeam:"SAS",awayTeam:"OKC",homeScore:null,awayScore:null,status:"scheduled"}],narrative:"TONIGHT: WCF Game 3 shifts to the Frost Bank Center with the series tied 1-1. Wemby's 41/24 Game 1 epic and SGA's 30-point Game 2 redemption have produced the best individual showcase of the 2026 playoffs. De'Aaron Fox is targeting a return from his ankle sprain — his presence would transform San Antonio's offense and reduce Castle's turnover burden (9 in Game 2). Jalen Williams expected to ramp to 15-20 minutes for OKC. The team that wins Games 3-4 at home will control the series.",keyMatchup:"SGA vs Wemby is the marquee matchup, but Fox's return status is the real swing factor. With Fox, the Spurs have the most talented starting five remaining. Without him, Castle's playmaking burden creates turnovers OKC converts into transition points.",seriesOdds:"OKC -130"},
];

// --- Playoff Performers ---

export const playoffPerformers: PlayoffPerformer[] = [
  {rank:1,player:"Jalen Brunson",team:"NYK",ppg:28.5,rpg:4.0,apg:10.0,statLine:"19 PTS, 14 AST, 0 TO in ECF Game 2 blowout",trend:"up",highlight:"From 38 PTS in Game 1 to 14 AST in Game 2 — the most complete two-game Conference Finals start in the 2026 postseason. NYK leads 2-0."},
  {rank:2,player:"Victor Wembanyama",team:"SAS",ppg:31.0,rpg:20.5,apg:4.5,statLine:"31.0 PPG, 20.5 RPG in WCF — historically unprecedented",trend:"steady",highlight:"Averaging 31.0 PPG and 20.5 RPG in the WCF. Tonight's Game 3 at home could be the signature game of his career. Fox may return."},
  {rank:3,player:"Shai Gilgeous-Alexander",team:"OKC",ppg:29.4,rpg:5.8,apg:7.1,statLine:"30 PTS, 9 AST, +14 in WCF Game 2 redemption",trend:"steady",highlight:"Bounced back from 8-24 Game 1 with 30/9/+14. Faces first road test tonight at the Frost Bank Center with series tied 1-1."},
  {rank:4,player:"Josh Hart",team:"NYK",ppg:22.0,rpg:4.5,apg:5.0,statLine:"26 PTS, 7 AST, 5-11 3PT, +18 in ECF Game 2",trend:"up",highlight:"Career-playoff-high 26 with five threes. Freed Brunson to become a pure facilitator. The Knicks' second option delivered his biggest game."},
  {rank:5,player:"Alex Caruso",team:"OKC",ppg:24.0,rpg:3.0,apg:4.0,statLine:"48 PTS on 65% FG across 2 WCF games",trend:"steady",highlight:"The best bench player in the 2026 Conference Finals. His Game 3 in a hostile road environment will test his WCF brilliance."},
  {rank:6,player:"Stephon Castle",team:"SAS",ppg:21.0,rpg:5.0,apg:9.5,statLine:"25 PTS, 8 AST, 9 TO in WCF Game 2",trend:"steady",highlight:"Castle's dual nature — brilliant scorer, volatile playmaker. Fox's return tonight could unlock him by reducing the ball-handling burden."},
  {rank:7,player:"Donovan Mitchell",team:"CLE",ppg:27.5,rpg:4.0,apg:1.5,statLine:"26 PTS, 1 AST, -8 in ECF Game 2 loss",trend:"down",highlight:"Scoring 27.5 PPG in the ECF but 0-2. Just 1 assist in Game 2 as Cleveland's spacing collapsed. Must carry CLE at home in Games 3-4."},
  {rank:8,player:"Karl-Anthony Towns",team:"NYK",ppg:18.0,rpg:11.5,apg:1.0,statLine:"18 PTS, 13 REB, 7-12 FG, +18 in ECF Game 2",trend:"up",highlight:"Dominated Allen on the glass — 13 REB in 36 minutes. His efficient scoring and rebounding are the Knicks' overlooked X-factor."},
  {rank:9,player:"OG Anunoby",team:"NYK",ppg:16.0,rpg:4.5,apg:2.0,statLine:"14 PTS, 3 BLK, game-high +22 in ECF Game 2",trend:"up",highlight:"The defensive anchor — his +22 came while making Harden a -22 shell. His return from injury has transformed NYK's identity."},
  {rank:10,player:"Mikal Bridges",team:"NYK",ppg:18.5,rpg:4.0,apg:2.5,statLine:"19 PTS, 9-12 FG (75%), +20 in ECF Game 2",trend:"up",highlight:"Shot 75% from the field while defending Mitchell. Four Knicks in the top ten — that is why NYK is 2-0."},
];

// --- MVP Candidates ---

export const mvpCandidates: MvpCandidate[] = [
  {rank:1,player:"Jalen Brunson",team:"NYK",odds:"+200",playoffAvg:"28.5 PPG, 10.0 APG, 4.0 RPG (ECF)",record:"10-2 (leads ECF 2-0)",signatureMoment:"38-point comeback masterpiece in Game 1, then 14 assists with 0 turnovers in Game 2's blowout. Two completely different games, two dominant wins. Two wins from the Finals.",trend:"up"},
  {rank:2,player:"Victor Wembanyama",team:"SAS",odds:"+225",playoffAvg:"26.3 PPG, 12.5 RPG, 3.2 BPG",record:"9-4 (WCF tied 1-1)",signatureMoment:"41 PTS, 24 REB in double-OT Game 1 road win at OKC without Fox. His WCF averages — 31.0 PPG, 20.5 RPG — are historically unprecedented. Tonight's Game 3 at home is pivotal.",trend:"steady"},
  {rank:3,player:"Shai Gilgeous-Alexander",team:"OKC",odds:"+175",playoffAvg:"29.4 PPG, 5.8 RPG, 7.1 APG",record:"9-1 (WCF tied 1-1)",signatureMoment:"30/9/+14 Game 2 redemption after 8-24 Game 1 nightmare. The back-to-back regular-season MVP needs a strong road Game 3 tonight to cement his candidacy.",trend:"steady"},
  {rank:4,player:"Donovan Mitchell",team:"CLE",odds:"+4000",playoffAvg:"27.5 PPG, 4.0 RPG, 1.5 APG (ECF)",record:"8-6 (trails ECF 0-2)",signatureMoment:"55 combined points in two ECF games but 0-2 — scoring without winning impact. Must carry Cleveland at home in Games 3-4 or his candidacy ends.",trend:"down"},
  {rank:5,player:"Josh Hart",team:"NYK",odds:"+10000",playoffAvg:"22.0 PPG, 4.5 RPG, 5.0 APG (ECF)",record:"10-2 (leads ECF 2-0)",signatureMoment:"Career-playoff-high 26 PTS with 5 threes in ECF Game 2. The Knicks' second option delivered his biggest game on the biggest stage.",trend:"up"},
];

// --- Elimination Watch ---

export const eliminationWatch: EliminationWatch[] = [
  {team:"NYK",opponent:"CLE",situation:"LEADING 2-0 after 109-93 Game 2 blowout. Hart 26, Brunson 14 AST. Series shifts to Cleveland for Games 3-4 on Saturday and Monday. Two wins from the Finals.",gameInfo:"NYK 109, CLE 93 (May 21) — Game 3: Sat May 23 at CLE, 8 PM ET, ABC.",urgency:"leading"},
  {team:"CLE",opponent:"NYK",situation:"TRAILING 0-2 after losing both games at MSG by a combined 27 points. Shot 5-24 from three in Game 2. Must win Games 3-4 at home or face elimination. No team in the 3-pointer era has come back from 0-2 in a Conference Finals losing both road games.",gameInfo:"NYK 109, CLE 93 (May 21) — Game 3: Sat May 23 at CLE, 8 PM ET, ABC.",urgency:"trailing"},
  {team:"OKC",opponent:"SAS",situation:"TIED 1-1 — WCF Game 3 TONIGHT at Frost Bank Center. SGA bounced back with 30/9 in Game 2. Jalen Williams expected 15-20 min. First road game in the WCF.",gameInfo:"Game 3: TONIGHT Fri May 22 at SAS, 8:30 PM ET, NBC.",urgency:"tied"},
  {team:"SAS",opponent:"OKC",situation:"TIED 1-1 — WCF Game 3 TONIGHT at home. Fox targeting return from ankle sprain. Wemby averaging 31.0 PPG and 20.5 RPG. Home crowd at Frost Bank Center could be decisive.",gameInfo:"Game 3: TONIGHT Fri May 22 at SAS, 8:30 PM ET, NBC. Fox questionable.",urgency:"tied"},
...
export const bracketMeta = {
  ...
  currentRound: "Conference Finals — ECF: NYK leads CLE 2-0, WCF: OKC-SAS tied 1-1",
  nextMilestone: "TONIGHT 8:30 PM ET — WCF Game 3: OKC @ SAS on NBC. ECF Game 3: Sat May 23 at CLE, 8 PM ET, ABC.",
  teamsRemaining: 4,
  teamsEliminated: 16,
  gamesPlayed: 51,
  playInComplete: true,
