...
export const gamePreviews = [
  {homeTeam:"BOS",homeRecord:"56-26",awayTeam:"PHI",awayRecord:"45-37",time:"7:30 PM ET",tv:"NBC, Peacock",spread:"BOS -4.5",overUnder:"218.5",keyMatchup:"Jayson Tatum vs. Joel Embiid",storyline:"Game 5 arrives at TD Garden with the series tied 2-2 after Philadelphia's stunning Game 4 victory shifted momentum completely toward the underdog Sixers. Boston faces elimination pressure at home while Joel Embiid's vintage playoff dominance has proven the Sixers can compete with championship-level execution. This winner-take-all atmosphere will determine which team advances to face the winner of the Knicks-Hawks series in what promises to be an electric playoff showdown.",prediction:"BOS wins 114-109 — Tatum's home-court excellence seizes series control in hostile environment",featured:true}
];
